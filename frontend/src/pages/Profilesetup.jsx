...
const Select = ({ field, options, placeholder, value, onChange, style }) => (
                        ...
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 1rem' }}>
                                ...
                                <Field label="Gender" required>
                                    <Select field="gender" options={['Female', 'Male', 'Other', 'Prefer not to say']} placeholder="Select gender" {...inp('gender')} />
                                </Field>
                            </div>
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <Field label="Department" required>
                                <Select field="dept" options={DEPTS} placeholder="Select department" {...inp('dept')} />
                            </Field>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0 1rem' }}>
                                <Field label="Batch (Graduation Year)" required>
                                    <Select field="batch" options={BATCHES} placeholder="Select batch" {...inp('batch')} />
                                </Field>
                                <Field label="Current Semester" required>
                                    <Select field="semester" options={SEMESTERS} placeholder="Semester" {...inp('semester')} />
                                </Field>
